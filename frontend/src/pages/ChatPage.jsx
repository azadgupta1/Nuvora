...
//     <div className="flex-1 flex flex-col overflow-hidden">
//       {/* Header */}
//       <div className="bg-gray-900 text-white px-6 py-4 flex items-center shadow">
...
//           <div
//             key={idx}
//             className={`max-w-[70%] px-4 py-2 rounded-xl shadow text-sm relative ${
//               msg.senderId === senderId
...
//       {/* Input */}
//       <div className="px-4 py-3 bg-gray-900 border-t border-gray-800 flex items-center gap-3">
//         {/* Image Upload */}
...
//           type="text"
//           placeholder="Type a message..."
//           className="flex-1 px-4 py-2 rounded-full text-sm bg-gray-800 text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500"
//           value={message}
//           onChange={(e) => setMessage(e.target.value)}
