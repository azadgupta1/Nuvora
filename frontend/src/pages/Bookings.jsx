...
//         if (response.ok) {
//           setBookings(data.bookings);
//           console.log("Toast error: ", data.message);
//         } else {
//           toast.error(data.message || "Failed to fetch bookings"); // ✅ toast for error
//         }
//       } catch (error) {
//         console.error("Error fetching bookings:", error);
...
//       // ✅ Toast when status is updated
//        console.log("Received bookingStatusUpdated:", updatedBooking);
//       toast.success(`Booking for ${updatedBooking.skillName} was ${updatedBooking.status}`);
//     });
...
//       if (response.ok) {
//         setBookings((prev) => prev.filter((booking) => booking.id !== bookingId));
//         toast.success("Booking cancelled successfully!"); // ✅ Use toast instead of alert
//       } else {
...
//       console.log("Received bookingStatusUpdated:", updatedBooking);
//       // Correct skill name access here:
//       toast.success(`Booking for ${updatedBooking.skill.name} was ${updatedBooking.status}`);
//     });
